...
#1. Load Data ----
#db updated this to paper specific folder
file_path <- "S:/IOECLS_Staff_Folders/Bann/crosscinequality/data, analyses/46c/bmiprs"
...
df_long <- df_raw %>%
  rename(prs_ksig  = adultbmi_prs_richardson2020, #[db added]
         prs_k = bmi_prs_khera,
